...
namespace LibGenerateZaFoms.Utils
{
    public class ActionZaDelay
    {
        ...
        public static void CreatePDF(LibGenerateZaFoms.Models.ZaDelay z, bool showFile = true)
        {
            ...
            //ДУЛ
            LibGenerateZaFoms.Utils.ActionZaDelay.SetDoc(ref sheet, z.doc);
            //Гражданство
            ...
            //Представитель
            if (z.agent != null) LibGenerateZaFoms.Utils.ActionZaDelay.SetAgent(ref sheet, z.agent);
        ...
        public static void CreateListPDF(List<LibGenerateZaFoms.Models.ZaDelay> lz, bool showFile = true, bool merge = true)
        {
            ...
            if (merge)
            {
                string filename = Path.Combine(lz[0].PathOut, "Zdelay" + DateTime.Now.ToString("ddMMyyyyHHmmss") + ".pdf");
