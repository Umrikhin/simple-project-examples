...
namespace LibGenerateZaFoms.Models
{
    public class ZaDelay
    {
        ...
        public ZaDelay() 
        {
            ...
            PathTemplate = System.IO.Path.Combine(path.DirectoryName, "Template", "ZaDelay.xlsx");
            PathFile = string.Empty;
            PathOut = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Заявления приостановки");
        }
    }
}
