...
namespace LibGenerateZaFoms.Models
{
    public class ZaGet
    {
        ...
        public ZaGet()
        {
            ...
            PathTemplate = System.IO.Path.Combine(path.DirectoryName, "Template", "ZaGet.xlsx");
            PathFile = string.Empty;
            PathOut = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Заявления предоставления выписки");
        }
    }
}
